...
const entrySchema = new mongoose.Schema(
  { userId: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
    name: String, avatarUrl: String, batch: String, branch: String,
    leetcodeScore: Number, githubScore: Number, totalScore: Number, rank: Number },
  { _id: false }
);
...
const leaderboardSnapshotSchema = new mongoose.Schema(
  { platform: { type: String, enum: ['leetcode','github','combined'], required: true },
    ...
    periodStart: Date, periodEnd: Date, entries: [entrySchema],
