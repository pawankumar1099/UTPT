...
const TrainerLayout = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-100">
      <TrainerSidebar profile={profile} isMobileMenuOpen={isMobileMenuOpen} setIsMobileMenuOpen={setIsMobileMenuOpen} />
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <TrainerTopbar profile={profile} onMenuClick={toggleMobileMenu} />
